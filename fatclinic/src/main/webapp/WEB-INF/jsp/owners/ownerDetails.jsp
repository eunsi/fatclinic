...
<petclinic:layout pageName="owners">
    ...
    <h2 id="ownerInformation">Member Information</h2>
    ...
    <a href="${fn:escapeXml(editUrl)}" class="btn btn-default">Edit Member</a>

    <spring:url value="{ownerId}/pets/new" var="addUrl">
        <spring:param name="ownerId" value="${owner.id}"/>
    </spring:url>
    <a href="${fn:escapeXml(addUrl)}" class="btn btn-default">Add New Trainer</a>

    <br/>
    <br/>
    <br/>
    <h2 id="petsAndVisits">Members and Visits</h2>
                    ...
                    <table class="table-condensed" aria-describedby="petsAndVisits">
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="${fn:escapeXml(petUrl)}">Edit Trainer</a>
                            </td>
                            <td>
